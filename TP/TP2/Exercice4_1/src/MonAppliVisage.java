...
/**
 * Appel classes VisagesRond et Dessin
 * 
 */

public class MonAppliVisage  {
    ...
    public static void main(String[] args) {
        ...
        Dessin d = new Dessin(); //d=zone de dessin
        laFenetre.add(d);
        ...
        VisageRond  v1 = new VisageRond();
			VisageRond  v2 = new VisageRond(50,50);  // --> modif: creation d'un deuxieme visages
