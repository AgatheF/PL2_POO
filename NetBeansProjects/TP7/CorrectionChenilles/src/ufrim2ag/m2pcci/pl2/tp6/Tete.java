...
public class Tete extends Anneau {
    ...
    // méthode pour convertir le cap de degré à radian
    ...
    public void deplacerSelonCap() {
        x = (int) (x + r * Math.cos(Math.PI * cap / 180)); // trigo
        y = (int) (y + r * Math.sin(Math.PI * cap / 180));
    }

    /**
     * teste si le cap actuel garantit que le prochain déplacement de la tête selon
